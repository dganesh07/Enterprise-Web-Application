...
<div id="container">
    ...
    <nav>
    	<ul>
        	<li class="start selected"><a href="welcomeLogin.html">Home</a></li>
            ...
            <li class="order"><a href="ordertrack.html">Your Orders</a></li>
			<li class="order"><a href='logout'>Logout</a></li>
     ...
     <aside class="sidebar">
            ...
            <ul>    
               <li>
                    <h4>Products</h4>
                    <ul>
                        <li><a href="SmartPhones?category=SmartPhones">SmartPhones</a></li>
                        <li><a href="SmartPhones?category=Tablets">Tablets</a></li>
                        <li class=""><a href="SmartPhones?category=Laptop">Laptops</a></li> 
                        <li><a href="SmartPhones?category=TV">TV</a></li>
