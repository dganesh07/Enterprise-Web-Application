...
public class ShoppingCart {
  ...
  //public synchronized void addItem(String itemID,HttpSession session)
  public synchronized void addItem(String itemID) {
    ...
    //ItemOrder newOrder = new ItemOrder(Catalog.getItem(itemID,session));
 ...
 // public synchronized void setNumOrdered(String itemID,int numOrdered,HttpSession session) 
  ...
  public synchronized void setNumOrdered(String itemID,
    ...
    ItemOrder newOrder =
      //new ItemOrder(Catalog.getItem(itemID,session));
